...
public final class MecanumDrive {
    public static class Params {
        ...
        public double inPerTick = 0.0029524653;
        public double lateralInPerTick = 0.0024180107858725506;
        public double trackWidthTicks = 4217.267765648752;

        // feedforward parameters (in tick units)
        public double kS = 0.9373676110224531;
